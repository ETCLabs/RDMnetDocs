...
<tagfile doxygen_version="1.9.1" doxygen_gitid="ef9b20ac7f8a8621fcfc299f8bd0b80422390f4b">
  ...
  <compound kind="file">
    <name>client.h</name>
    <path>/tmp/tmpppu5c7kz/rdmnet/include/rdmnet/cpp/</path>
  ...
  <compound kind="file">
    ...
    <path>/tmp/tmpppu5c7kz/rdmnet/include/rdmnet/cpp/message_types/</path>
  ...
  <compound kind="file">
    <name>opts.h</name>
    <path>/tmp/tmpppu5c7kz/rdmnet/src/rdmnet/core/</path>
  ...
  <compound kind="page">
    ...
    <docanchor file="building_and_integrating.html">md__tmp_tmp2du0l6hu_docs_getting_started_building_and_integrating</docanchor>
  </compound>
  <compound kind="page">
    <name>data_ownership</name>
    <title>Data Ownership Paradigms in the RDMnet Library</title>
    <filename>data_ownership.html</filename>
    <docanchor file="data_ownership.html">md__tmp_tmp2du0l6hu_docs_getting_started_data_ownership</docanchor>
  </compound>
  <compound kind="page">
    <name>getting_started</name>
    <title>Getting Started</title>
    <filename>getting_started.html</filename>
    <docanchor file="getting_started.html">md__tmp_tmp2du0l6hu_docs_getting_started_getting_started</docanchor>
  </compound>
  <compound kind="page">
    ...
    <docanchor file="global_init_and_destroy.html">md__tmp_tmp2du0l6hu_docs_getting_started_global_init_and_destroy</docanchor>
  </compound>
  <compound kind="page">
    <name>handling_rdm_commands</name>
    <title>Handling RDM Commands</title>
    <filename>handling_rdm_commands.html</filename>
    <docanchor file="handling_rdm_commands.html">md__tmp_tmp2du0l6hu_docs_getting_started_handling_rdm_commands</docanchor>
  </compound>
  <compound kind="page">
    <name>using_broker</name>
    <title>Using the Broker API</title>
    <filename>using_broker.html</filename>
    <docanchor file="using_broker.html">md__tmp_tmp2du0l6hu_docs_getting_started_using_broker</docanchor>
  </compound>
  <compound kind="page">
    <name>using_controller</name>
    <title>Using the Controller API</title>
    <filename>using_controller.html</filename>
    <docanchor file="using_controller.html">md__tmp_tmp2du0l6hu_docs_getting_started_using_controller</docanchor>
  </compound>
  <compound kind="page">
    <name>using_device</name>
    <title>Using the Device API</title>
    <filename>using_device.html</filename>
    <docanchor file="using_device.html">md__tmp_tmp2du0l6hu_docs_getting_started_using_device</docanchor>
  </compound>
  <compound kind="page">
    <name>using_ept_client</name>
    <title>Using the EPT Client API</title>
    <filename>using_ept_client.html</filename>
    <docanchor file="using_ept_client.html">md__tmp_tmp2du0l6hu_docs_getting_started_using_ept_client</docanchor>
  </compound>
  <compound kind="page">
    <name>using_llrp_manager</name>
    <title>Using the LLRP Manager API</title>
    <filename>using_llrp_manager.html</filename>
    <docanchor file="using_llrp_manager.html">md__tmp_tmp2du0l6hu_docs_getting_started_using_llrp_manager</docanchor>
  </compound>
  <compound kind="page">
    <name>devices_and_gateways</name>
    <title>Devices and Gateways</title>
    <filename>devices_and_gateways.html</filename>
    <docanchor file="devices_and_gateways.html">md__tmp_tmp2du0l6hu_docs_how_rdmnet_works_devices_and_gateways</docanchor>
  </compound>
  <compound kind="page">
    <name>discovery</name>
    <title>Discovery</title>
    <filename>discovery.html</filename>
    <docanchor file="discovery.html">md__tmp_tmp2du0l6hu_docs_how_rdmnet_works_discovery</docanchor>
  </compound>
  <compound kind="page">
    <name>ept</name>
    <title>Extensible Packet Transport (EPT)</title>
    <filename>ept.html</filename>
    <docanchor file="ept.html">md__tmp_tmp2du0l6hu_docs_how_rdmnet_works_ept</docanchor>
  </compound>
  <compound kind="page">
    <name>how_it_works</name>
    <title>How RDMnet Works</title>
    <filename>how_it_works.html</filename>
    <docanchor file="how_it_works.html">md__tmp_tmp2du0l6hu_docs_how_rdmnet_works_how_it_works</docanchor>
  </compound>
  <compound kind="page">
    <name>llrp</name>
    <title>Low-Level Recovery Protocol (LLRP)</title>
    <filename>llrp.html</filename>
    <docanchor file="llrp.html">md__tmp_tmp2du0l6hu_docs_how_rdmnet_works_llrp</docanchor>
  </compound>
  <compound kind="page">
    <name>roles_and_addressing</name>
    <title>Roles and Addressing</title>
    <filename>roles_and_addressing.html</filename>
    <docanchor file="roles_and_addressing.html">md__tmp_tmp2du0l6hu_docs_how_rdmnet_works_roles_and_addressing</docanchor>
  </compound>
  <compound kind="page">
    <name>index</name>
    <title>RDMnet</title>
